...
fundamentallm train data/raw/shakespeare/shakespeare_complete.txt --output-dir comp_model_deep --model-dim 512 --batch-size 64 --num-heads 16 --epochs 50 --learning-rate 0.0003 --dropout 0.2 --mixed-precision --gradient-clip 1.0 --device cuda
